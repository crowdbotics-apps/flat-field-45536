"""
Django settings for flat_field_45536 project.
...
ROOT_URLCONF = 'flat_field_45536.urls'
...
WSGI_APPLICATION = 'flat_field_45536.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "flat_field_45536 API",
    "DESCRIPTION": "API documentation for flat_field_45536 App",
    "VERSION": "v1",
}
